...
import { ReactComponent as SerachSVG } from './Assets/Search.svg';
        ...
        <div>
          ...
          <div className="bg-gradient-to-t from-black to-transparent absolute bottom-0 w-screen grid grid-cols-3 justify-center h-20 items-center">
              <div className="text-gray-300 text-sm text-center">
                <HomeSVG width={25} height={25} className="mx-auto" />
                <h1 className="mt-1">Home</h1>
              </div>
              <div className="text-gray-300 text-sm text-center">
                <SerachSVG width={25} height={25} className="mx-auto fill-current" />
                <h1 className="mt-1">Search</h1>
              </div>  
              <div className="text-gray-300 text-sm text-center">
                <LibrarySVG width={25} height={25} className="mx-auto" />
